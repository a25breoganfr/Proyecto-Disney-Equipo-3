    ...
    public static void LinkAPI() throws Exception {
      ...
      /*  HttpClient client = HttpClient.newHttpClient();
        ...
        */
        ...
        //Creo objeto GSON
        Gson gson = new Gson();
        Response disneyResponse = gson.fromJson(response.body(), Response.class);
        CharacterInfo[] personajes = disneyResponse.data;
        ...
        guardarInfo(personajes);

    }
	//Metodo para guardar personajes
    private static void guardarInfo(CharacterInfo[] personajes) throws IOException {
